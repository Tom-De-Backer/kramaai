...
class Jins extends Component {
    render() {
        return (
            <Tak
                name="Jins"
                explanation=" JIN staat voor ‘Jij en Ik een Noodzaak’ en zijn 17-18 jaar. Ze
              ...
              op buitenlands kamp."
                leiding="Door wie de JIN's dit jaar worden bijgestaan kan je %s terugvinden. "
                video="https://www.kramaai.be/images/videos/2023-2024/Jins.mp4"
            />
        );
    }
}
